    ...
    def process_url(self, url):
        ...
        try:
            ...
            if video_info['duration'] > self.max_duration:
                ...
                self.ui.print_warning(f"Video is longer than {hours} hours. This may take a while...")
            ...
            self.ui.print_info("This may take several minutes depending on video length...")
            
            result = self.transcriber.transcribe(audio_file)
            formatted_transcript = self.transcriber.format_transcript(result)
            ...
            print(preview + "..." if len(formatted_transcript['full_text']) > 500 else preview)
            print("=" * 60 + "\n")
        ...
        while True:
            try:
                ...
                # Handle YouTube URL
                    ...
                    self.ui.print_error("Invalid input. Please enter a valid YouTube URL or command.")
